...
import { GenerationMosCard } from "@/features/text-to-speech/components/generation-mos-card";
      ...
      <TextToSpeechForm key={generationId} defaultValues={defaultValues}>
        <div className="flex min-h-0 flex-1 overflow-hidden">
          <div className="flex min-h-0 flex-1 flex-col overflow-y-auto">
            <div className="min-h-[260px] shrink-0 lg:min-h-[320px]">
              <TextInputPanel />
            </div>
            <VoicePreviewMobile
            ...
            <VoicePreviewPanel
              ...
              text={data.text}
            />
            <GenerationMosCard generationId={generationId} />
          </div>
          <SettingsPanel />
        </div>
      </TextToSpeechForm>
