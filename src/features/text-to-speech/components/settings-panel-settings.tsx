...
import { MultilingualLanguageSelector } from "@/features/text-to-speech/components/multilingual-language-selector";
...
export function SettingsPanelSettings() {
  ...
  return (
    <>
      ...
      <div className="border-b border-dashed p-4 space-y-4">
        <VoiceSelector />
